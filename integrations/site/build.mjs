...
await fs.mkdir(path.join(out,'assets/lib'),{recursive:true});await fs.mkdir(path.join(out,'zh'),{recursive:true});
...
await fs.writeFile(path.join(out,'sitemap.xml'),`<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>${SITE}</loc></url><url><loc>${SITE}zh/</loc></url></urlset>\n`);
